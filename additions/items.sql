...
INSERT INTO public."PARAMETERS"(
	...
	(1590313064687461465, 413, 'Esterházy Cake', null, 0, 0),   
	...
	(1590313064688510044, 414, 'Fanta 250 мл.', null, 0, 0),
	(1590313064688510044, 409, '137', null, 0, 0),

	(1590313064688510045, 413, 'Sprite', null, 0, 0),   
	(1590313064688510045, 408, null, null, 0, 817),
	(1590313064688510045, 414, 'Sprite 250 мл.', null, 0, 0),
	(1590313064688510045, 409, '137', null, 0, 0),

	(1590313064688510046, 413, 'Orange juice', null, 0, 0),   
	(1590313064688510046, 408, null, null, 0, 817),
	(1590313064688510046, 414, 'Orange juice freshly squeezed 500 мл.', null, 0, 0),
	(1590313064688510046, 409, '490', null, 0, 0),

	(1590313064688510047, 413, 'Schweppes', null, 0, 0),   
	(1590313064688510047, 408, null, null, 0, 817),
	(1590313064688510047, 414, 'Schweppes 250 мл.', null, 0, 0),
	(1590313064688510047, 409, '140', null, 0, 0),

	(1590313064688510048, 413, 'Coca-Cola', null, 0, 0),   
	(1590313064688510048, 408, null, null, 0, 817),
	(1590313064688510048, 414, 'Coca-Cola 1000 мл.', null, 0, 0),
	(1590313064688510048, 409, '170', null, 0, 0);


INSERT INTO public."ATTRIBUTES"(
	"ATTR_ID", "NAME", "ATTR_TYPE_ID")
	VALUES (418, 'Item image', 53);

	INSERT INTO public."OBJECTS"(
	"NAME",  "PARENT_ID", "OBJECT_TYPE_ID")
	VALUES ('/resources/img/pizza/pizza_meat.jpg', 0, 301),    
('/resources/img/pizza/pizza_europe.jpg', 0, 301),   
('/resources/img/pizza/pizza_bbq.jpg', 0, 301),  
('/resources/img/pizza/pizza_diablo.jpg', 0, 301),
('/resources/img/pizza/pizza_peperoni.jpg', 0, 301),
('/resources/img/pizza/pizza_vegan.jpg', 0, 301);  
...
(1590313064687461440, 418, null, null, 1590348921347761254, 0);
	...
	INSERT INTO public."OBJECTS"(
	"NAME",  "PARENT_ID", "OBJECT_TYPE_ID")
	VALUES ('/resources/img/sushi/sushi_california.png', 0, 301), 
('/resources/img/sushi/sushi_creamy_shrimp.png', 0, 301), 
('/resources/img/sushi/sushi_chicken_and_cheese.png', 0, 301),  
('/resources/img/sushi/sushi_chicken_spice.png', 0, 301),  
('/resources/img/sushi/sushi_filadelfia.png', 0, 301);  
...
(1590313064687461442, 418, null, null, 1590349951498183787, 0);
	...
	"NAME",  "PARENT_ID", "OBJECT_TYPE_ID")
	VALUES 
('/resources/img/burgers/burger_new_york.jpg', 0, 301), 
('/resources/img/burgers/burger_texas.jpg', 0, 301), 
('/resources/img/burgers/burger_with_salmon.jpg', 0, 301), 
('/resources/img/burgers/burger_bbq.jpg', 0, 301), 
('/resources/img/burgers/cheeseburger.jpg', 0, 301), 
('/resources/img/burgers/burger_mexica.jpg', 0, 301),
('/resources/img/burgers/fish_burger.jpeg', 0, 301), 
('/resources/img/burgers/black_burger.jpg', 0, 301); 
...
(1590313064687461453, 418, null, null, 1590350533458912371, 0);
	...
	INSERT INTO public."OBJECTS"(
	"NAME",  "PARENT_ID", "OBJECT_TYPE_ID")
	VALUES ('/resources/img/salads/salad_cesar.jpg', 0, 301), 
('/resources/img/salads/salad_with_veal_greens.jpg', 0, 301), 
('/resources/img/salads/salad_with_spinach.jpg', 0, 301), 
('/resources/img/salads/salad_greek.jpg', 0, 301), 
('/resources/img/salads/salad_toscana.jpg', 0, 301); 
...
(1590313064687461458, 418, null, null, 1590351152602145912, 0);
	...
	INSERT INTO public."OBJECTS"(
	"NAME",  "PARENT_ID", "OBJECT_TYPE_ID")
	VALUES ('/resources/img/snacks/schack_chicken_naggets.jpg', 0, 301), 
('/resources/img/snacks/snack_toasted_garlic.jpg', 0, 301), 
('/resources/img/snacks/snack_french_fries.jpg', 0, 301),  
('/resources/img/snacks/snack_rings_squids.jpg', 0, 301), 
('/resources/img/snacks/snack_cheese_nag.jpg', 0, 301); 
...
(1590313064687461463, 418, null, null, 1590351706102424701, 0);
	...
	INSERT INTO public."OBJECTS"(
	"NAME",  "PARENT_ID", "OBJECT_TYPE_ID")
	VALUES ('/resources/img/dessert/desert_cheesecake.jpg', 0, 301), 
('/resources/img/dessert/desert_esterházy.jpg', 0, 301), 
('/resources/img/dessert/desert_tiramisu.jpg', 0, 301), 
('/resources/img/dessert/desert_cheese_pancake.jpg', 0, 301); 
...
(1590313064688510043, 418, null, null, 1590352234943341705, 0);
	...
	INSERT INTO public."OBJECTS"(
	"NAME",  "PARENT_ID", "OBJECT_TYPE_ID")
	VALUES ('/resources/img/beverages/beverages_fanta.png', 0, 301), 
('/resources/img/beverages/beverages_sprite.png', 0, 301),  
('/resources/img/beverages/beverages_orange_juce.png', 0, 301), 
('/resources/img/beverages/beverages_schweps.png', 0, 301), 
('/resources/img/beverages/beverages_cola.png', 0, 301); 
