...
INSERT INTO public."LOC_STRINGS"(
	...
	(2590313064688510048, 401, 81, 'Heineken'),
...
INSERT INTO public."LOC_STRINGS"(
	"OBJECT_ID", "ATTR_ID", "LANG_ID", "LOC_TEXT_VALUE")
	VALUES (1590313064830067771, 401, 82, 'М?ясна Піца'),
	...
	(1590313064687461437, 414, 82, 'Соус Сіті-Піца, сир моцарелла, м?ясо курчати, бекон, печериці, болгарський перець, червоний лук, французький цибуля, соус барбекю'),
	...
	(1590313064687461447, 414, 82, 'М?ясо на грилі з Гуакамоле, пікантний соус Піко де Галло з перцем Чіпотле і сиром Чеддер зі свіжою булочкою Prentzel'),
	...
	(1590313064687461455, 414, 82, 'Смажене теляче м?ясо, огірки, помідори, баклажани, рукола, кінза, червоний лук, медово-бальзамічний соус'),
	...
	(1590313064687461457, 414, 82, 'Суміш свіжих овочів, салату Айсберг, оливок і м?якого сиру з пряними нотками базиліка і кунжуту'),
	...
	(2590313064688510048, 401, 82, 'Heineken'),
